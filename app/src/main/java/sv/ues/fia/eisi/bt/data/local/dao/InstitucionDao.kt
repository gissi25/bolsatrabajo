...
class InstitucionDao(private val db: ConnectionHelper) {
    ...
    fun getAll(): List<Institucion> {
        ...
        return results.map { row ->
            Institucion(
                id_institucion = row[0] as Int,
                nombre_institucion = row[1] as String
            )
        }
    }

    fun getById(id: Int): Institucion? {
    ...
    fun delete(id: Int): Int = db.deleteById("INSTITUCION", "ID_INSTITUCION", id)
