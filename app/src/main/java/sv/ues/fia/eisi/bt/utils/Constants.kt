...
object Constants {
    ...
    const val KEY_POSTULANTE_ID = "postulante_id"
    ...
    const val TABLE_TIPO_CERTIFICACION = "TIPO_CERTIFICACION"
    ...
    const val BUNDLE_TABLE_DISPLAY_NAME = "table_display_name"
    ...
    fun getColumnsForTable(tableName: String): List<String> {
        return when (tableName) {
            ...
            "POSTULANTE" -> listOf("ID_POSTULANTE", "ID_GENERO", "ID_TIPO_DOCUMENTO", "NUM_DOCUMENTO", "ID_GRADO_ACADEMICO", "ID_DISTRITO_DEPTO", "ID_DISTRITO_MUNICIPIO", "ID_DISTRITO_ID", "NOMBRE", "APELLIDO", "FECHA_NACIMIENTO", "NUP", "DIRECCION_DETALLE", "TELEFONO_CASA", "TELEFONO_CELULAR", "EMAIL")
            ...
            "CERTIFICACION" -> listOf("ID_CERTIFICACION", "ID_INSTITUCION", "ID_POSTULANTE", "ID_TIPO_CERTIFICACION", "NOMBRE_CERTIFICACION", "FECHA_INICIO", "FECHA_FIN", "FECHA_CERTIFICACION")
            "TIPO_CERTIFICACION" -> listOf("ID_TIPO_CERTIFICACION", "NOMBRE_TIPO")
            ...
            "FORMACION_ACADEMICA" -> listOf("ID_FORMACION", "ID_POSTULANTE", "ID_OFERTA_ACADEMICA", "TITULO_OBTENIDO", "FECHA_INICIO", "FECHA_FIN", "FECHA_OBTENCION")
    ...
    fun getPrimaryKeyColumns(tableName: String): List<String> {
        return when (tableName) {
            ...
            "TIPO_CERTIFICACION" -> listOf("ID_TIPO_CERTIFICACION")
