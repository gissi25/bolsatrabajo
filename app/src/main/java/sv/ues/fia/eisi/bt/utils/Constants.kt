...
object Constants {
    ...
    fun getColumnsForTable(tableName: String): List<String> {
        return when (tableName) {
            ...
            "CERTIFICACION" -> listOf("ID_CERTIFICACION", "ID_INSTITUCION", "ID_POSTULANTE", "ID_TIPO_CERTIFICACION", "NOMBRE_CERTIFICACION", "FECHA_CERTIFICACION", "FECHA_INICIO", "FECHA_FIN")
