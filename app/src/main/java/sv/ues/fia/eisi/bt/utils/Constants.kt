...
object Constants {
    ...
    fun getColumnsForTable(tableName: String): List<String> {
        return when (tableName) {
            ...
            "CERTIFICACION" -> listOf("ID_CERTIFICACION", "ID_INSTITUCION", "ID_POSTULANTE", "ID_TIPO_CERTIFICACION", "NOMBRE_CERTIFICACION", "FECHA_CERTIFICACION", "PERIODO")
            ...
            "FORMACION_ACADEMICA" -> listOf("ID_FORMACION", "ID_POSTULANTE", "ID_OFERTA_ACADEMICA", "TITULO_OBTENIDO", "PERIODO", "FECHA_OBTENCION")
